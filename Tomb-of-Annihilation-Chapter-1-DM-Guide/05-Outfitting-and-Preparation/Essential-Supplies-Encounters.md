...
*Use these individual encounters when players need to purchase specific essential supplies. Each encounter focuses on one critical item, helping players understand why it's essential and what happens if they don't have it.*

## Overview

This document breaks down the Essential Supplies Checklist into individual encounters. Each encounter focuses on one critical supply item, allowing the DM to emphasize its importance and create memorable shopping moments. Use these encounters when players are shopping for supplies and need to understand why each item matters.

---

## Encounter 1: Water Containers
...
>
> 'I've seen expeditions fail because they didn't bring enough water or their containers broke. You can't rely on finding clean water in the jungle - most sources are contaminated, and drinking from them means disease. You need to carry your water with you, and you need containers that won't break.
>
...
- **Insufficient water**: Players run out of water, requiring dangerous water sources that cause disease

---

## Encounter 2: Food Rations
...
>
> 'I've supplied dozens of expeditions, and I can tell you: you'll need more food than you think. You'll get lost, waste days, and need reserves. One ration per person per day is the minimum, and that's for a week. But you should bring more - at least two weeks' worth if you can carry it.
>
...
- **Insufficient food**: Players run out of food, requiring dangerous foraging that may lead to poisoning or encounters

---

## Encounter 3: Insect Repellent
...
>
> 'Without protection, you'll be making daily Constitution saves against disease. Every day. And if you fail, you'll get sick, and sickness in the jungle is often fatal. Disease kills more adventurers than creatures do - I've seen strong warriors brought down by a single mosquito bite.
>
...
- **No protection**: Constant exposure to disease-carrying insects increases risk dramatically

---

## Encounter 4: Tents with Insect Netting
...
>
> 'But more than that, you need shelter from the weather. Tropical storms hit almost daily - torrential rain that can destroy everything you own if you're not protected. The rain can last for hours, and without shelter, your gear gets soaked, your food spoils, and you risk hypothermia even in the heat.
>
...
- **No weather protection**: Storms destroy gear, spoil food, and cause exhaustion

---

## Encounter 5: Rain Catchers
...
>
> 'These rain catchers (5 gp) are designed for tropical conditions. They collect rainwater during storms, filter out debris, and store it safely. With a rain catcher, you can supplement your carried water and reduce the risk of running out.
>
...
- **Missed opportunities**: Daily storms provide free water, but without catchers, it's wasted

---

## Encounter 6: Canoes (If Traveling by River)
...
>
> 'These canoes (50 gp) are designed for Chult's rivers. They're sturdy enough to handle rapids and shallow enough to navigate narrow channels. A canoe can carry your entire party plus supplies, and it's much faster than walking.
>
...
- **More encounters**: Ground travel exposes players to more dangers
...
- **During shopping scenes**: Use individual encounters when players are shopping for specific items
- **When players skip items**: Use encounters to emphasize the importance of missing supplies
- **For emphasis**: Use encounters to create memorable moments about critical supplies
- **For education**: Use encounters to teach players about jungle survival requirements

### How to Combine

- **Sequential shopping**: Run encounters one after another as players shop
- **Selective encounters**: Choose 2-3 most critical encounters based on what players are missing
- **Integrated shopping**: Mix these encounters with general shopping scenes

### Adapting Encounters

- **Combine items**: Merge multiple items into a single encounter if time is limited
- **Skip optional items**: Focus on must-have items (water, food, insect repellent, tents)
- **Customize merchants**: Make each merchant unique with different personalities and approaches
...
- **If need more supplies**: → [Supplies-and-Gear.md](./Supplies-and-Gear.md) - Complete supplies guide
- **If need more information**: → [City-Overview.md](../02-Arrival-in-Port-Nyanzaru/City-Overview.md) - Return to city exploration

### Related Sections

- [Supplies-and-Gear.md](./Supplies-and-Gear.md) - Complete supplies and gear guide with all encounters
