# Guide Recruiters in Port Nyanzaru
...
- Individuals with maps and equipment lists
- The bearing of professional expedition organizers
- Guides actively recruiting in taverns, markets, or near docks
- Multiple guide options being presented
- The importance of choosing the right guide
- Recruiters who may have their own agendas

## Immediate Options for Players

1. **Listen to recruiter pitches** - Hear about available guides and their specialties
2. **Ask questions** - Inquire about guide experience, methods, and destinations
3. **Observe guides** - Use Perception/Investigation to assess reliability
4. **Research guide reputations** - Use Investigation to learn about past expeditions
5. **Read recruiter motivations** - Use Insight to detect hidden agendas
6. **Negotiate terms** - Use Persuasion to get better deals or more information
7. **Request interviews** - Ask to meet guides directly before deciding
...
**DC 12 Perception Check**: Observe recruiters and guides for signs of reliability

- **Success**: "You notice details about the recruiters and the guides they're promoting: the quality of their equipment, their bearing, how they present themselves. Some appear more professional and reliable than others. You can identify which guides seem trustworthy and which might be risky choices."
- **Failure**: "The recruiters and guides all seem capable, but you can't determine which ones are most reliable or experienced."
- **Critical Success (17+)**: "Your observation is comprehensive: you can identify specific signs of experience (old scars, well-maintained equipment, confident bearing), detect signs of trouble (nervousness, poor equipment, suspicious behavior), and even notice subtle details that reveal each guide's true capabilities and potential problems. You can make an informed decision about which guide to consider."

**DC 13 Investigation Check**: Research recruiter and guide reputations

- **Success**: "By asking around and investigating, you can learn about the recruiters and the guides they're promoting: their past expeditions, their success rate, and what previous clients have said about them. You can identify which guides are reliable and which have problematic histories."
- **Failure**: "The recruiters' and guides' backgrounds are difficult to verify, and you can't determine their true reputations."
- **Critical Success (18+)**: "Your investigation reveals detailed information: you learn about each recruiter's connections and motivations, each guide's complete history, their success and failure rates, their methods, and even rumors about their secrets or hidden agendas. You can identify which recruiters are honest brokers versus those pushing specific guides for their own reasons. You might even discover specific information about guide destinations or methods that helps you make a better choice."

### Additional Skill Checks

**DC 11 Insight Check**: Read recruiters' true motivations and detect deception

- **Success**: "You can sense the recruiters' true motivations. Some are genuinely trying to help you find the right guide, while others may be pushing specific guides for commissions or other reasons. You can identify which recruiters are trustworthy and which you should approach with caution."
- **Failure**: "The recruiters seem helpful, but you can't determine their true motivations or if they're being completely honest."
- **Critical Success (16+)**: "Your insight is penetrating: you can detect specific motivations (genuine helpfulness, commission-seeking, hidden agendas), identify when recruiters are exaggerating guide capabilities, sense which guides recruiters genuinely recommend versus those they're pushing for personal gain, and even predict how different recruiters will react to your questions. You can identify the best way to interact with each recruiter to get honest information."

**DC 12 Persuasion Check**: Get recruiters to share honest information or better deals

- **Success**: "Your friendly approach and genuine interest help build rapport. The recruiters become more open, sharing additional information about guides, their methods, and potential concerns. They may even offer to arrange better terms or introduce you to guides not initially presented."
- **Failure**: "The recruiters remain polite but stick to their prepared pitches, sharing only basic information."
- **Critical Success (17+)**: "Your approach is so effective that recruiters become genuinely helpful. They share valuable information about guide strengths and weaknesses, warn you about potential problems, offer to arrange interviews with multiple guides, and may even provide discounts or additional services. Some recruiters might introduce you to guides they normally wouldn't recommend, giving you more options."

**DC 10 History Check**: Recall information about guide recruiters or their organizations

- **Success**: "You remember hearing about guide recruitment in Port Nyanzaru. Some recruiters work independently, while others are associated with Merchant Prince Kwayothe's organization or the guide guild. Their reputations vary, and some are known to be more reliable than others."
- **Failure**: "You don't recall specific information about guide recruiters or their organizations."
- **Critical Success (15+)**: "Your historical knowledge is extensive: you recall detailed information about the guide recruitment system in Port Nyanzaru, which recruiters are associated with which organizations, their reputations for honesty, and even rumors about specific recruiters' methods or connections. You know which recruiters are trustworthy brokers versus those who might have hidden agendas."

## NPC Stats

### Guide Recruiter (Generic Template)

- **Role**: Expedition organizer, guide broker, information source
- **Personality**: Professional, helpful, business-focused, may have hidden agendas
- **Appearance**: Carries maps and equipment lists, professional bearing, approachable demeanor
- **Location**: Found in taverns, markets, docks, or guide guild offices
- **Knowledge**:
  - Information about available guides and their specialties
  - Knowledge of guide reputations and past expeditions
  - Understanding of expedition requirements and logistics
  - Information about jungle dangers and the importance of guides
  - May know about guide secrets or hidden agendas
- **Information They Provide**:
  - Guide options and their specialties
  - Basic information about guide experience
  - Pricing and terms
  - Warnings about jungle dangers
  - Recommendations (which may be influenced by commissions)
- **Interaction DCs**:
  - **Persuasion (DC 12)**: Get honest information or better deals
  - **Insight (DC 11)**: Detect hidden motivations or agendas
  - **Investigation (DC 13)**: Research recruiter and guide reputations
  - **History (DC 10)**: Recall recruiter organizations and reputations
- **Secrets/Agendas**:
  - May receive commissions for specific guide recommendations
  - May be associated with Merchant Prince Kwayothe or guide guild
  - May have personal preferences or biases toward certain guides
  - May push guides for reasons other than client best interest

## Guide Options Presented (Fast-Track: 2-3 Options)

### Option 1: Eku (Recommended by Recruiter)

**Recruiter's Pitch**: "Eku is one of our most experienced guides. She knows the jungle like few others, understands survival, and has extensive knowledge of ancient ruins. She's calm, professional, and has an excellent survival record. Her rates are reasonable, and she's known for getting expeditions where they need to go safely."

**Quick Details**:

- **Cost**: 50 gp upfront + share of treasure
- **Specialty**: Jungle survival, ancient ruins, safe routes
- **Personality**: Calm, knowledgeable, mysterious
- **Why Recommended**: Excellent survival record, reasonable rates

### Option 2: Salida

**Recruiter's Pitch**: "Salida is a professional guide who specializes in navigation and avoiding dangers. She's efficient, business-like, and gets expeditions where they need to go quickly. She's more expensive, but her clients consistently reach their destinations with minimal problems."

**Quick Details**:

- **Cost**: 100 gp upfront + share of treasure
- **Specialty**: Navigation, avoiding dangers, efficient travel
- **Personality**: Professional, efficient, business-like
- **Why Recommended**: Fast, reliable, professional

### Option 3: [Your Choice]

**Recruiter's Pitch**: "[Customize based on guide selected]"

**Quick Details**:

- **Cost**: Varies
- **Specialty**: [Based on selected guide]
- **Personality**: [Based on selected guide]
- **Why Recommended**: [Based on recruiter's pitch]

## What Recruiters Say (Key Dialogue)

### Initial Approach

"'New to Port Nyanzaru, are you? Planning an expedition into the jungle? You'll need a guide - that's not optional, it's essential. The jungle kills the unprepared, and even experienced adventurers can get lost or worse without proper guidance. I represent several excellent guides, each with their own specialties. Let me introduce you to some options...'"

### About the Importance of Guides

"'The jungle doesn't forgive mistakes. Even the most experienced adventurers can get lost, fall to disease, or fall prey to the countless dangers that lurk in the undergrowth. A good guide doesn't just know the way - they know how to avoid danger, find water, treat disease, and navigate terrain that would kill the unprepared. Without a guide, your chances of survival drop dramatically.'"

### About Guide Selection
...
- **After meeting recruiters**: → [Hiring-Guides.md](./Hiring-Guides.md) - Complete guide selection with full details
- **If players want to interview guides**: → [Hiring-Guides.md](./Hiring-Guides.md) - Meet guides directly
- **If players want more information**: → [Gathering-Information.md](../03-City-Exploration-and-Social-Play/Gathering-Information.md) - Research guide options
- **If players want official guide guild**: → [Hiring-Guides.md](./Hiring-Guides.md) - Visit Merchant Prince Kwayothe's office
