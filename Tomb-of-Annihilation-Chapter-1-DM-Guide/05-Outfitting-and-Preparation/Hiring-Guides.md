...
- Kwayothe's office or the guide guild
- Multiple guide candidates with distinct appearances and personalities
- Each guide's equipment, bearing, and demeanor
- The weight of an important decision
- Guides who may have hidden agendas or secrets

## Immediate Options for Players

1. **Interview guides** - Ask questions about experience, methods, and destinations
2. **Observe guides** - Use Perception/Investigation to assess reliability
3. **Research guide reputations** - Use Investigation to learn about past expeditions
4. **Read guide motivations** - Use Insight to detect hidden agendas
5. **Negotiate terms** - Use Persuasion to get better deals or more information
6. **Make a choice** - Select a guide based on gathered information
...
**DC 12 Perception Check**: Observe guides for signs of experience or reliability

- **Success**: "You notice details about each guide: the quality of their equipment, scars from past adventures, how they carry themselves. Some appear more experienced and reliable than others. You can identify which guides seem trustworthy and which might be risky choices."
- **Failure**: "The guides all seem capable, but you can't determine which ones are most reliable or experienced."
...
**DC 13 Investigation Check**: Research guide reputations and backgrounds

- **Success**: "By asking around and investigating, you can learn about each guide's reputation: their past expeditions, their success rate, and what previous clients have said about them. You can identify which guides are reliable and which have problematic histories."
- **Failure**: "The guides' backgrounds are difficult to verify, and you can't determine their true reputations."
- **Critical Success (18+)**: "Your investigation reveals detailed information: you learn about each guide's complete history, their success and failure rates, their methods, and even rumors about their secrets or hidden agendas. You can identify which guides are genuinely helpful, which have ulterior motives, and which might be dangerous. You might even discover specific information about their destinations or methods that helps you make a better choice."

### Additional Skill Checks

**DC 11 Insight Check**: Read guides' true motivations and detect deception

- **Success**: "You can sense each guide's true motivations. Some are genuinely helpful and experienced, while others might have hidden agendas or be less capable than they claim. You can identify which guides are being honest and which are hiding something."
- **Failure**: "The guides seem sincere, but you can't determine their true motivations or detect if they're being deceptive."
- **Critical Success (16+)**: "Your insight is penetrating: you can detect specific motivations (greed, duty, personal agendas, desperation), identify when guides are lying or exaggerating their capabilities, sense hidden secrets or agendas, and even predict how each guide will behave in different situations. You can identify which guides will be reliable partners versus those who might cause problems."

**DC 12 Persuasion Check**: Negotiate better terms or gather more information

- **Success**: "Your diplomatic approach helps you negotiate better terms, get more information about each guide, or convince them to be more open about their methods and expectations. Guides are more willing to share details or offer better deals."
- **Failure**: "The guides stick to their standard terms and aren't willing to negotiate or share additional information."
- **Critical Success (17+)**: "Your negotiation is highly effective: you can secure significantly better terms (lower costs, better treasure splits, additional services), get guides to reveal more about their methods and secrets, and even convince them to provide upfront information about dangers or routes. Some guides might offer to provide additional resources or contacts."

**DC 10 History Check**: Recall information about guides or their reputations

- **Success**: "You remember hearing about some of these guides before. Their names or reputations ring a bell, and you can recall basic information about their past expeditions or methods."
- **Failure**: "The guides' names don't ring any bells, though they clearly have some experience."
- **Critical Success (15+)**: "Your historical knowledge is extensive: you recall detailed information about each guide's past expeditions, their successes and failures, their methods, and even rumors about their secrets or agendas. This knowledge helps you make a more informed decision about which guide to hire."

## NPC Stats

### Niles Breakbone (River Guide)

- **Role**: Expert canoeist and river route guide
- **Personality**: Gruff, practical, distrustful of outsiders, protective of Chult
- **Background**: Chultan native with extensive knowledge of river systems
- **Destination**: River routes, Omu area, waterways of Chult
- **Knowledge**:
  - Extensive knowledge of Chult's river systems
  - Understanding of river dangers and navigation
  - Knowledge of areas accessible by water
  - Information about tribes and settlements along rivers
- **Interaction DCs**:
  - **Persuasion (DC 13)**: Gain his trust and better terms
  - **Insight (DC 12)**: Detect his hidden agenda
  - **Investigation (DC 13)**: Learn about his family connections
- **Secrets/Agendas**:
  - Has family in Obo'laka'ki and may have ulterior motives
  - May prioritize family interests over party goals
  - Distrustful of outsiders but loyal to those who earn his trust

### Ashton Greymane (Jungle Guide)

- **Role**: Professional guide following official routes
- **Personality**: Professional, reliable, rule-following, military-minded
- **Background**: Former Flaming Fist scout with military training
- **Destination**: Official paths, Fort Beluarian, established routes
- **Knowledge**:
  - Knowledge of official expedition routes
  - Understanding of Flaming Fist operations and locations
  - Military tactics and survival skills
  - Information about established safe areas
- **Interaction DCs**:
  - **Persuasion (DC 12)**: Negotiate terms or gather information
  - **Insight (DC 13)**: Detect his Flaming Fist connections
  - **History (DC 12)**: Recall Flaming Fist reputation
- **Secrets/Agendas**:
  - Reports to Flaming Fist superiors
  - May prioritize Flaming Fist interests
  - Reliable but may have divided loyalties

### Lhara Quickstep (Treasure Hunter Guide)

- **Role**: Guide focused on treasure and ruins
- **Personality**: Cheerful, greedy, optimistic, adventurous
- **Background**: Halfling adventurer seeking riches and adventure
- **Destination**: Ruins with treasure potential, ancient sites, hidden locations
- **Knowledge**:
  - Knowledge of ruins and ancient sites
  - Information about treasure locations
  - Understanding of traps and ancient dangers
  - Connections to other treasure hunters
- **Interaction DCs**:
  - **Persuasion (DC 12)**: Negotiate treasure splits
  - **Insight (DC 11)**: Detect her greed and potential unreliability
  - **Investigation (DC 12)**: Learn about her past expeditions
- **Secrets/Agendas**:
  - Will abandon party for big scores
  - Prioritizes treasure over party safety
  - Optimistic but potentially unreliable in dangerous situations

### Qawasha (Tribal Guide)

- **Role**: Guide with tribal connections and nature knowledge
- **Personality**: Mysterious, spiritual, connected to nature, wise
- **Background**: Tabaxi hunter from the jungle with deep tribal connections
- **Destination**: Tribal lands, hidden paths, spiritual sites, nature-focused routes
- **Knowledge**:
  - Extensive knowledge of jungle tribes and their territories
  - Understanding of nature and jungle survival
  - Information about spiritual sites and ancient practices
  - Connections to various tribal groups
- **Interaction DCs**:
  - **Persuasion (DC 14)**: Gain his trust (difficult for outsiders)
  - **Nature (DC 12)**: Connect through shared nature knowledge
  - **Insight (DC 13)**: Detect his tribal agenda
- **Secrets/Agendas**:
  - Serves a tribal agenda
  - May prioritize tribal interests over party goals
  - Mysterious but potentially very helpful if trust is earned

## How to Present Guides

- **Location**: Merchant Prince Kwayothe's office or guide guild
- **Format**: Let players interview candidates
